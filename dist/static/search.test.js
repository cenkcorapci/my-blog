...
describe('BlogSearch', () => {
    ...
    const mockData = {
        posts: [
            ...
            { id: 'post-2', title: 'JavaScript Guide', date: '2024-01-02', tags: null, slug: 'post-2' }
        ],
        invertedIndex: {
            'go': ['post-1'],
            'programming': ['post-1'],
    ...
    beforeEach(() => {
        ...
        blogSearch.posts = mockData.posts.map(p => ({ ...p, tags: p.tags || [] }));
    ...
    test('search should handle null tags gracefully', () => {
        // post-2 has null tags in raw data, but our init fixes it
